...
@note Offical Implementation of GELTOR published in WWW'23
...
def parse_args(graph='',dataset_name='',result_dir='output/', dimension=128, topK=-1, iterations=5, epochs=300, batch_size=-1, learning_rate=0.0025, reg_rate=0.001, early_stop=True, wait_thr=20, gpu_on=True):
    ...
    parser.add_argument('--topk', type=int, default=topK, help='Number of nodes in topK; default is -1 (i.e., topK is automatically computed as explained in the paper), otherwise input the value manually')
    ...
    parser.add_argument('--bch', type=int, default=batch_size, help='batch size, default is -1 (i.e., it is automatically computed as explained in the paper), otherwise input the value manually')
