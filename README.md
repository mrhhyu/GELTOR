...
```
### NOTE:
1- By using **topk_mnl** flag, you can input topk value manually (i.e., **topk_mnl=True**) or to calculate it automatically as explained in the paper (i.e., **topk_mnl=False**), the default value is False; we suggest to set topk automatically. 
...
2- By using **bch_mnl** flag, you can input the batch size manually (i.e., **bch_mnl=True**) or to calculate it automatically as explained in the paper (i.e., **bch_mnl=False**), the value default is False; the latter case is recommended.
